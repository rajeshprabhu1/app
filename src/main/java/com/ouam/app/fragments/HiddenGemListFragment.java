...
public class HiddenGemListFragment extends BaseFragment implements UpdatePagerFragmentInterface {
    ...
    private void setAdapter() {
        ...
        mAdapter = new UserPinsAdapter(getActivity(), AppConstants.HIDDEN_GEM_PIN_LIST,isMyProfile);
