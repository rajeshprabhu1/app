...
public class FollowRecommendListAdapter extends RecyclerView.Adapter<FollowRecommendListAdapter.Holder> {
    ...
    public FollowRecommendListAdapter(Context context, ArrayList<UserProfileEntity> activityFeedList,
                                      DiscreteScrollView discreteScrollView, int screenWidthInt, InterfaceBtnCallBack followInterfaceBtnCallBack) {
        mContext = context;
    ...
    public Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.adap_recommendation_follow_view, parent, false);
