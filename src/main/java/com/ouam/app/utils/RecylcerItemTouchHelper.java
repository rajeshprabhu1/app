...
public class RecylcerItemTouchHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public RecylcerItemTouchHelper(int dragDirs, int swipeDirs, RecyclerItemTouchHelperListener listener) {
    ...
    public void onSelectedChanged(RecyclerView.ViewHolder holder, int actionState) {
        if (holder != null) {
            final View foregroundView = ((ChatListAdapter.Holder) holder).mviewback;
    ...
    public void onChildDrawOver(Canvas c, RecyclerView recyclerView,
        ...
        final View foregroundView = ((ChatListAdapter.Holder) holder).mviewfore;
